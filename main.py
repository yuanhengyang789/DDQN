...
def generate_map(size=20, obstacle_ratio=0.3):
...
class DualReplayMemoryObstacle:
    ...
    def push(self, state, action, reward, next_state, done, pos, map_array):
...
def main():
    ...
    map = generate_map(size=20, obstacle_ratio=0.3)
    start_pos = (19, 0)
    target_pos = (0, 19)
